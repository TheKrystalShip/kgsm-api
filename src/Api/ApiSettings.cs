...
public sealed class ApiSettings
{
    ...
    /// name.</panel>
    [ConfigField("hostId", "Host id", Group = "identity", Risk = ConfigRisk.Wiring, NoDefault = true)]
    ...
    [ConfigField("hostLabel", "Display name", Group = "identity", NoDefault = true)]
    ...
    [ConfigField("region", "Region", Group = "identity", NoDefault = true)]
    ...
    [ConfigField("monitorSocket", "Monitor socket", Group = "leaves", Type = ConfigType.Path,
    ...
    [ConfigField("watchdogSocket", "Watchdog socket", Group = "leaves", Type = ConfigType.Path,
        Risk = ConfigRisk.Wiring)]
    ...
    [ConfigField("assistantUrl", "Assistant URL", Group = "leaves", Risk = ConfigRisk.Wiring, NoDefault = true)]
    ...
    [ConfigField("assistantPublicUrl", "Assistant public URL", Group = "leaves", Risk = ConfigRisk.Wiring,
        NoDefault = true)]
    ...
    [ConfigField("firewallSocket", "Firewall socket", Group = "leaves", Type = ConfigType.Path,
    ...
    [ConfigField("reactorSocket", "Reactor socket", Group = "leaves", Type = ConfigType.Path,
        Risk = ConfigRisk.Wiring, NoDefault = true)]
    ...
    [ConfigField("speechSocket", "Speech socket", Group = "leaves", Type = ConfigType.Path,
        Risk = ConfigRisk.Wiring)]
    ...
    [ConfigField("botSocket", "Discord bot socket", Group = "leaves", Type = ConfigType.Path,
        Risk = ConfigRisk.Wiring, NoDefault = true)]
    ...
    [ConfigField("kgsmPath", "KGSM executable", Group = "engine", Type = ConfigType.Path, Risk = ConfigRisk.Wiring)]
    ...
    [ConfigField("kgsmJournalDir", "KGSM event journal", Group = "engine", Type = ConfigType.Path,
        Risk = ConfigRisk.Wiring)]
    ...
    [ConfigField("eventJournalDir", "Panel event journal", Group = "engine", Type = ConfigType.Path,
    ...
    [ConfigField("journalStateRoot", "Service state root", Group = "engine", Type = ConfigType.Path,
        Risk = ConfigRisk.Wiring)]
    ...
    [ConfigField("systemctlPath", "systemctl path", Group = "engine", Type = ConfigType.Path,
        Risk = ConfigRisk.Wiring)]
    ...
    [ConfigField("journalctlPath", "journalctl path", Group = "engine", Type = ConfigType.Path,
        Risk = ConfigRisk.Wiring)]
    ...
    [ConfigField("domainPollMs", "Server list refresh", Group = "polling", Min = 1000, Unit = "ms")]
    ...
    [ConfigField("metricsPollMs", "Metrics refresh", Group = "polling", Min = 250, Unit = "ms")]
    ...
    [ConfigField("servicesPollMs", "Services refresh", Group = "polling", Min = 2000, Unit = "ms")]
    ...
    [ConfigField("backupScanPollMs", "Backup scan interval", Group = "polling", Min = 30000, Unit = "ms")]
    ...
    [ConfigField("instanceCacheTtlSec", "Server detail cache", Group = "polling", Min = 10, Unit = "s")]
    ...
    [ConfigField("blueprintCacheTtlSec", "Blueprint cache", Group = "polling", Min = 10, Unit = "s")]
    ...
    [ConfigField("rawgApiKey", "RAWG API key", Group = "library", Type = ConfigType.Secret, NoDefault = true)]
    ...
    [ConfigField("rawgCacheDir", "Artwork cache directory", Group = "library", Type = ConfigType.Path,
        Risk = ConfigRisk.Destructive, NoDefault = true)]
    ...
    [ConfigField("steamCdnBase", "Steam art base URL", Group = "library")]
    ...
    [ConfigField("steamCoversDisabled", "Disable Steam cover art", Group = "library")]
    ...
    /// refresh off.</panel>
    [ConfigField("libraryRefreshIntervalDays", "Library refresh interval", Group = "library", Min = 0,
        Unit = "days")]
    ...
    [ConfigField("libraryRefreshHour", "Library refresh hour", Group = "library", Min = 0, Max = 23,
    ...
    [ConfigField("filesMaxEntries", "Directory listing limit", Group = "files", Min = 1)]
    ...
    [ConfigField("filesMaxEditBytes", "Editable file size limit", Group = "files", Min = 1024, Unit = "bytes")]
    ...
    [ConfigField("blueprintMaxEditBytes", "Editable blueprint size limit", Group = "files", Min = 1024,
        Unit = "bytes")]
    ...
    [ConfigField("logSources", "Log sources", Group = "logs", Type = ConfigType.Csv, NoDefault = true)]
    ...
    [ConfigField("logReadTimeoutMs", "Log read timeout", Group = "logs", Min = 500, Unit = "ms")]
    ...
    [ConfigField("leafOverridesDir", "Override directory", Group = "leafconfig", Type = ConfigType.Path,
        Risk = ConfigRisk.Wiring)]
    ...
    [ConfigField("leafDescriptorDir", "Descriptor directory", Group = "leafconfig", Type = ConfigType.Path,
        Risk = ConfigRisk.Wiring)]
    ...
    [ConfigField("leafDropInDir", "Drop-in directory", Group = "leafconfig", Type = ConfigType.Path,
        Risk = ConfigRisk.Wiring, NoDefault = true)]
    ...
    /// unhealthy.</panel>
    [ConfigField("leafApplyCanaryMs", "Post-change health window", Group = "leafconfig", Min = 2000, Unit = "ms")]
    ...
    [ConfigField("clusterGossipUrl", "Peer URL", Group = "cluster", Risk = ConfigRisk.Wiring, NoDefault = true)]
    ...
    [ConfigField("clusterGossipMs", "Peer exchange interval", Group = "cluster", Min = 250, Unit = "ms")]
    ...
    [ConfigField("clusterPollMs", "Peer refresh interval", Group = "cluster", Min = 250, Unit = "ms")]
    ...
    [ConfigField("clusterSuspectMs", "Peer suspect timeout", Group = "cluster", Min = 1000, Unit = "ms")]
    ...
    [ConfigField("clusterReapMs", "Peer removal timeout", Group = "cluster", Min = 1000, Unit = "ms")]
    ...
    [ConfigField("clusterDrainMs", "Outbox drain interval", Group = "cluster", Min = 250, Unit = "ms")]
    ...
    [ConfigField("clusterGcMs", "Cluster cleanup interval", Group = "cluster", Min = 60000, Unit = "ms")]
    ...
    [ConfigField("clusterRetryTtlDays", "Undelivered message lifetime", Group = "cluster", Min = 1, Unit = "days")]
    ...
    [ConfigField("clusterRetentionDays", "Cluster message retention", Group = "cluster", Min = 2,
    ...
    [ConfigField("dbPath", "Database file", Group = "storage", Type = ConfigType.Path, Risk = ConfigRisk.Destructive)]
