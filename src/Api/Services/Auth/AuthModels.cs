...
public static class SessionClaims
{
    ...
    /// <summary>
    /// The <see cref="KgsmAuthClaims.SessionId"/> claim (<c>sid_&lt;guid&gt;</c>), or <see langword="null"/>
    ...
    /// <summary>
    /// The <see cref="KgsmAuthClaims.Jti"/> claim (the per-token JWT ID), or <see langword="null"/> when
