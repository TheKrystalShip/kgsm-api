...
/// <c>Api__SessionsCacheTtlMs</c> (default 5s) so the hot path stays light — every active
...
public interface ISessionValidator
{
    ...
    /// immediately rather than waiting for the <c>Api__SessionsCacheTtlMs</c> backstop.
    /// </summary>
